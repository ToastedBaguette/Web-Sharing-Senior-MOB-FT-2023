          ...
          <div class="col">
            <div class="button-wrapper">
              ...
              @else
                ...
                <button class="red-button" id="button-a" onclick="response(1, '{{ $group->user->name }}')">
                  <h2>A</h2>
                </button>
                <button class="red-button" id="button-b" onclick="response(0, '{{ $group->user->name }}')">
                  <h2>B</h2>
                </button>
              @endif
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <section class="accepted-section">
            <h4>=== Accepted ===</h4>
            @if ($accepted != '')
              <input type="hidden" name="accepted_group_id" id="accepted_group_id" value="{{ $accepted->group_id }}">
              <div class="row">
                <div class="col">
                  {{ $accepted_user->name }}
                </div>
                <div class="col">
                  <button type="button" class="btn btn-danger" onclick="cancel(1, '{{ $accepted_user->name }}')">Cancel</button>
                </div>
              </div>
            @endif
          </section>
